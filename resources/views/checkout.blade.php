...
<section class="page-header page-header-xs">
            ...
            <section>
				<div class="container">
					...
					<!-- CHECKOUT -->
					<form class="row clearfix" method="post" action="shop-checkout-final.html">
							...
							<fieldset class="mt-60">
								...
								<div class="row">
									<div class="col-lg-12">
										...
										<input id="billing_address2" name="billing[address][]" type="text" class="form-control mt-10" placeholder="Address 2" />
									</div>
								</div>
						...
						<div class="col-lg-5 col-sm-5">
							...
							<!-- CREATE ACCOUNT -->
							<div class="toggle-transparent toggle-bordered-full mt-30 clearfix">
								<div class="toggle active">
									<div class="toggle-content">
										...
										<div class="clearfix">
											<label class="checkbox float-left">
												...
												<i></i> <span class="fw-300">Create an account for later use</span>
											</label>
										</div>

										<!-- CREATE ACCOUNT FORM -->
										<div id="newaccount" class="mt-10 mb-30 hide">
